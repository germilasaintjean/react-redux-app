...
const Home = () => {
  return (
    <div>
      ...
      <p><font size="4">Books plays an important role in in our life. It is said that books are our best companions.Books are real friends in our lives . They demand nothing from us. They give us plenty of joy.</font></p>
      <p><font size="4">We also learn a lot from them. They take us into a different world of imagination.</font></p>
      <img src="im.jpg" alt="Trulli" width="500" height="800"></img>
    </div>
  );
};
